...
public class SentenceDataRepository:MeadowCrudRepository<SentenceData,Guid>, ISentenceDataRepository
{
    ...
    public Result<SentenceData> ReadFirstUnSeenSentence(Guid activityId, string userEmail)
    {
            var request = new ReadFirstUnSeenSentenceRequest(activityId,userEmail);
